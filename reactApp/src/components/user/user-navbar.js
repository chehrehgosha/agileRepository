              ...
              <div id="myContainer">
                <nav className="topnav" id="myTopnav">
                  <ul>
                    <li>
                      <div className="dropdown">
                        ...
                        <div className="dropdown-content">
                          <Link to={"/user/myTransactions"}>My Commodities</Link>
                          <a to={"/user/wallet"}>My Wallet</a>
                          <a to={"/user/profile"}>View Profile</a>
                          <a to={"/user/profileedit"}>Edit Profile</a>
                          <a to={"/user/contactUs"}>Contact Us</a>
                    ...
                    <li>
                      <span to={"/user/convertCurrency"} id="convert_currency" >Button</span>
                    </li>
                    <li>
                      <Link to={"/user/chargeCredit"} id="charge_credit">Add Commodity</Link>
                    </li>
                    <li>
                      <span to={"/user/tests"} id="test_register">Button</span>
                    </li>
                    <li>
                      <span to="/user/notifications">Button</span>
                    </li>
                    <li>
                      <span to="/user/transfer" id={"transfer"}>Button</span>
                    </li>
                    <li>

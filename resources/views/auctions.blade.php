    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 ml-auto mr-auto text-center">
          <h2 class="title">لیست مزایده ها</h2>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="card card-plain">
        <div class="card-body">
          ...
          <form class="row">
            ...
            <div class="col-lg-3 col-sm-4">
              <div class="form-group has-default">
              <a href="/auctions"> <button type="button" class="btn btn-info btn-round">از نو</button></a>
              </div>
            </div>
            <div class="col-lg-3 col-sm-4">
              <div class="form-group has-default">
                ...
                <tr>
                  <td>
                    <div class="img-container">
                      <img src="{{ asset('assets/img/product' . $auction->id . '.jpg') }}" alt="...">
                    </div>
                  </td>
                  <td>
                  ...
                  <td class="td-number">
                  {{ $auction->base_price }}<small>تومان</small>
                  </td>
                  <td>
                    {{ $auction->city_name }}
                  </td>
                  ...
                  <td class="text-left">
                    <a href="/auctions/{{ $auction->id }}"> <button type="button" class="btn btn-info btn-round">خرید<i class="material-icons">keyboard_arrow_left</i></button></a>
                  </td>
                </tr>
              @endforeach
                <tr>
